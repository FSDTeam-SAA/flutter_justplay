...
class ProfileRepositoryImpl implements ProfileRepository {
  ...
  @override
  NetworkResult<void> registerDeviceToken(String deviceToken) {
    return _apiClient.post(
      endpoint: ApiConstants.profile.registerDeviceToken,
  ...
  @override
  NetworkResult<void> removeDeviceToken(String deviceToken) {
    return _apiClient.delete(
      endpoint: ApiConstants.profile.removeDeviceToken,
      data: {'deviceToken': deviceToken},
      fromJsonT: (json) {},
    );
  }
