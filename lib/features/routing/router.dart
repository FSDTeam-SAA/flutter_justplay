    ...
    try {
      ...
      if (hasToken) {
        ...
        if (userId != null && userId.isNotEmpty) {
          // Fire-and-forget: reconnect the realtime socket + push
          // notifications for an already logged-in session (app relaunch,
          // not a fresh login).
          Get.find<RealtimeController>().connect(userId);
          Get.find<PushNotificationService>().initialize();
        }
