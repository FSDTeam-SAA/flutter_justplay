...
class AppCachedImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (imageUrl == null || imageUrl!.isEmpty) {
      ...
      // Only intercept taps when the caller actually wants them — otherwise
      // this would swallow taps meant for an ancestor GestureDetector/InkWell
      // (e.g. a whole selectable card), since it wins the gesture arena.
      return onTap == null
          ? placeholder
